      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="home-wrapper text-center">
            ...
            <p class="animated fadeInDown wow" data-wow-delay=".2s">Minton is a fully featured premium admin template built on top of awesome Bootstrap 3.3.6, modern web technology HTML5, <br/> CSS3 and jQuery. It has many ready to use hand crafted components.</p>
